...
l.src=k;l.async=true;if(l.addEventListener){l.addEventListener("load",m,false)}else{if(l.readyState){l.onreadystatechange=m
}}return l}function c(k){var l=null;l=document.getElementsByTagName("head")[0];l.appendChild(k)
}function b(l){var k=null;k=(typeof d[l]!=="undefined");return k}function f(l){var k=null;
